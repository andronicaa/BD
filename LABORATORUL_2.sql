...
--19 --TEMA
SELECT last_name, department_name, d.location_id, d.department_id, commission_pct
FROM employees e JOIN departments d ON e.department_id = d.department_id
WHERE commission_pct <> 0;
...
--Exercitiul  21 - TEMA
SELECT   last_name, department_name, d.department_id, l.city
FROM employees e, departments d, locations l
WHERE d.department_id = e.department_id AND d.location_id = l.location_id AND city = 'Oxford';
--Exercitiul 22 - TEMA ? 

SELECT DISTINCT e1.employee_id "Cod_Ang", e1.last_name "Angajat", e2.manager_id "Cod_Mgr", e2.last_name "Manager"
FROM employees e1, employees e2
WHERE e1.employee_id <> e2.employee_id;


--afisare manageri
SELECT DISTINCT e1.last_name, e1.employee_id, e2.manager_id
FROM employees e1, employees e2
